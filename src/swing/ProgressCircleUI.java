...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/image/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/image/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/image/file.png")).getImage();
    }
